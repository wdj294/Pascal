...
namespace DigitalRubyShared
{
    public class DemoScriptComponent : MonoBehaviour
    {
        ...
        public void TapGestureExecuted(GestureRecognizer gesture, ICollection<GestureTouch> touches)
        {
            Debug.LogFormat("Tap gesture executing, state: {0}, pos: {1},{2}", gesture.State, gesture.FocusX, gesture.FocusY);
        }

        public void SwipeGestureExecuted(GestureRecognizer gesture, ICollection<GestureTouch> touches)
        {
        ...
        public void ScaleGestureExecuted(GestureRecognizer gesture, ICollection<GestureTouch> touches)
        {
        ...
        public void OneTouchScaleGestureExecuted(GestureRecognizer gesture, ICollection<GestureTouch> touches)
        {
        ...
        public void RotateGestureExecuted(GestureRecognizer gesture, ICollection<GestureTouch> touches)
        {
        ...
        public void PanGestureExecuted(GestureRecognizer gesture, ICollection<GestureTouch> touches)
        {
            Debug.LogFormat("Pan gesture executing, state: {0}, pos: {1},{2}", gesture.State, gesture.FocusX, gesture.FocusY);
        }

        public void LongPressGestureExecuted(GestureRecognizer gesture, ICollection<GestureTouch> touches)
        {
            Debug.LogFormat("Long press gesture executing, state: {0}, pos: {1},{2}", gesture.State, gesture.FocusX, gesture.FocusY);
        }

        public void ImageGestureExecuted(GestureRecognizer gesture, ICollection<GestureTouch> touches)
        {
