...
namespace AC
{
	...
	public class Music : Sound
	{
		...
		public void LoadMainData (MainData mainData)
		{
			...
			if (!string.IsNullOrEmpty (mainData.oldMusicTimeSamples))
			{
			...
			if (!string.IsNullOrEmpty (mainData.lastMusicQueueData))
			{
				lastQueuedMusic.Clear ();
			...
			if (!string.IsNullOrEmpty (mainData.musicQueueData))
			{
