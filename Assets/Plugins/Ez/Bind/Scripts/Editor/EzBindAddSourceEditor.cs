...
namespace Ez.Binding
{
    ...
    public class EzBindAddSourceEditor : EBaseEditor
    {
        ...
        {
            DrawHeader(EResources.HeaderBarBindAddSource.normal);
            EGUI.Space(SPACE_4);
            ...
            DrawEditor();
            EzBindEditor.UpdateBoundItem(ezBindAddSource.source, sourceInfo);
            EGUI.Space(SPACE_4);
        ...
        void DrawEditor()
        {
            ...
            EGUI.BeginHorizontal(WIDTH_420);
            {
                ...
                {
                    ezBindAddSource.bindName = bindName;
                    markSceneDirty = true;
                }
            }
            EGUI.EndHorizontal();
            ...
            if(!string.IsNullOrEmpty(bindName))
            {
                ...
                {
                    EGUI.FlexibleSpace();
                    EGUI.Label("Source: " + (sourceInfo.gameObject != null ? "Added" : "None"), ComponentSmallWhiteTextStyle);
                    EGUI.Space(6);
                }
                EGUI.EndHorizontal();
            }
            ...
            if(EGUI.BeginFadeGroup(show.faded) && !string.IsNullOrEmpty(bindName))
            {
                ...
                {
                    EGUI.Space(SPACE_16);
                    EGUI.DrawTexture(ezBindAddSource.source.gameObject == null ? EResources.RedBackground : EResources.PurpleBackground, WIDTH_420 - SPACE_16 - 18, 18);
                    EGUI.Space(36);
                }
                EGUI.EndHorizontal();
                EGUI.Space(-19);
                EGUI.BeginHorizontal(WIDTH_420);
                {
                    ...
                    sourceInfo.gameObject = ezBindAddSource.gameObject;
                    GUI.enabled = false;
                    ...
                    if(EGUI.ButtonReset())
                    {
                        ...
                        ezBindAddSource.source.Reset();
                        ezBindAddSource.source.gameObject = ezBindAddSource.gameObject;
                        markSceneDirty = true;
                    }
                }
                EGUI.EndHorizontal();
                ...
                {
                    EGUI.Space(SPACE_16);
                    EGUI.DrawTexture(ezBindAddSource.source.component == null ? EResources.RedBackground : EResources.PurpleBackground, WIDTH_420 - SPACE_16, 18);
                    EGUI.Space(36);
                }
                EGUI.EndHorizontal();
                EGUI.Space(-19);
                ...
                {
                    EGUI.Space(SPACE_16);
                    EGUI.DrawTexture((string.IsNullOrEmpty(ezBindAddSource.source.variableName) || ezBindAddSource.source.variableName.Equals("None")) ? EResources.RedBackground : EResources.PurpleBackground, WIDTH_420 - SPACE_16, 18);
                    EGUI.Space(36);
                }
                EGUI.EndHorizontal();
                EGUI.Space(-19);
        ...
        void UpdateData()
        {
            bindName = ezBindAddSource.bindName;
            EzBindEditor.UpdateBoundItemInfo(sourceInfo, ezBindAddSource.source);
        }
    }
}
