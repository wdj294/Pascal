...
namespace PixelCrushers.QuestMachine
{
    ...
    /// <summary>
    /// Urgency based on the affinity between two factions, scaled by the number of entities.
    /// </summary>
    public class ThreatUrgencyFunction : UrgencyFunction
    {
        ...
        public override string typeName { get { return "By Threat"; } }
        ...
        public override float Compute(WorldModel worldModel)
        {
            ...
            else
            {
                ...
                {
                    return entityCountMultiplier.Evaluate(worldModel.observed.count) * Mathf.Max(0, -observerFaction.GetAffinity(observedFaction));
                }
            }
            return 0;
        }
