...
namespace PixelCrushers.QuestMachine
{
    ...
    /// <summary>
    /// Custom inspector for MessageQuestCondition assets.
    /// </summary>
    [CustomEditor(typeof(MessageQuestCondition), true)]
    public class MessageQuestConditionEditor : QuestSubassetEditor
    {

        protected override void Draw()
        {
            if (serializedObject == null) return;
            EditorGUILayout.HelpBox("This condition listens for a message from the Message System.", MessageType.None);
