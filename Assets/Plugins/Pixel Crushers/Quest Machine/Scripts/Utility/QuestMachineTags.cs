...
namespace PixelCrushers.QuestMachine
{
    ...
    public static class QuestMachineTags
    {
        ...
        private static TagDictionary tagDictionary { get; set; }
        ...
        public static string ReplaceTags(string s, Quest quest)
        {
            ...
            tagDictionary = (quest != null) ? quest.tagDictionary : null;
            var regex = new Regex(@"\{[^\}]+\}");
        ...
        private static string ReplaceTag(Match m)
        {
            ...
            else
            {
                ...
                // Otherwise try from tag dictionary:
                if (tagDictionary != null && tagDictionary.ContainsTag(tag))
                {
                    return tagDictionary.dict[tag];
                }
        ...
        private static string ReplaceCounterTag(string s, CounterTagType tagType)
        {
            ...
            var counterName = s.Substring(2, s.Length - 3).Trim();
