...
namespace TutorialDesigner.FullSerializer.Internal {
    public class fsCyclicReferenceManager {
        public static fsCyclicReferenceManager self;
        ...
        public static int GetReferenceIdFromObj(object item) {
            return self.GetReferenceId(item);
        }

        public static object GetReferenceObjectById(int id) {            
            return self.GetReferenceObject(id);
        }
