...
using System.Text;
using TutorialDesigner.FullSerializer.Internal;
...
namespace TutorialDesigner.FullSerializer {
    ...
    public class fsAotCompilationManager {
        ...
        private static string GenerateDirectConverterForTypeInCSharp(Type type, fsMetaProperty[] members, bool isConstructorPublic) {
            ...
            sb.AppendLine();
            sb.AppendLine("namespace TutorialDesigner.FullSerializer {");
            ...
            sb.AppendLine("}");
            sb.AppendLine();
            sb.AppendLine("namespace TutorialDesigner.FullSerializer.Speedup {");
