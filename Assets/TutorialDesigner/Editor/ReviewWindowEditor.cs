...
namespace TutorialDesigner
{
    ...
    public class ReviewWindowEditor : EditorWindow
    {
		...
		private static string keyName = "TutorialDesigner-Review";
        ...
        {		
			...
			EditorGUILayout.BeginHorizontal();
			GUILayout.Space(30);
			EditorGUILayout.LabelField("Review Tutorial Designer", GUILayout.Width(200));
			EditorGUILayout.EndHorizontal();
            ...
            {
                Help.BrowseURL("https://www.assetstore.unity3d.com/#!/content/74382");
                DisableRating();
            }
